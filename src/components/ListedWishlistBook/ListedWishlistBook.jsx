                ...
                <div className='border-b mb-4'>
                    ...
                    <div className='my-4 flex flex-col lg:flex-row gap-4'>
                        <p className='text-[#131313] font-bold'>Tags:
                            {tags.map((tag, index) => (
                                <span key={index} className='btn btn-xs md:btn-sm lg:btn-sm hover:bg-[#23BE0A0D] hover:text-[#23BE0A] hover:border-[#23BE0A] rounded-full bg-[#23BE0A0D] text-[#23BE0A] font-medium ml-2 md:ml-3 lg:ml-3'>#{tag}</span>
                            ))}
                        </p>
